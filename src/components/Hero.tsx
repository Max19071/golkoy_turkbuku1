  ...
  return (
    <section id="home" className="relative h-screen flex items-center justify-center bg-gray-200">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-400 bg-gray-300">
        ...
        <span className="text-lg font-medium opacity-70 uppercase tracking-widest">{isEnglish ? 'Main Image Area' : 'Ana Görsel Alanı'}</span>
      </div>
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-20">
        <h1 className="text-4xl md:text-6xl font-serif text-white mb-6 drop-shadow-md">
          {isEnglish ? 'An Exclusive Holiday in Bodrum' : "Bodrum'da Ayrıcalıklı Bir Tatil"}
        </h1>
        <p className="text-lg md:text-xl text-gray-100 mb-10 max-w-2xl mx-auto drop-shadow-md">
          {isEnglish
            ? 'A luxurious and comfortable stay where you can create unforgettable memories accompanied by the unique Bodrum scenery.'
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            {isEnglish ? 'Explore Rooms' : 'Odaları Keşfet'}
          </a>
          <a 
            href="#book" 
